...
The script [extract-osx-sdk.sh](https://github.com/cartcrypto/cart/blob/master/contrib/macdeploy/extract-osx-sdk.sh) automates this. First ensure
...
cart/contrib/macdeploy/extract-osx-sdk.sh
...
Troubleshooting
---------------
See [README_osx.md](https://github.com/cartcrypto/cart/blob/master/doc/README_osx.md) for troubleshooting tips.