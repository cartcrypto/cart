...
1. Clone the cart Coin source code:

        git clone https://github.com/cartcrypto/cart
        cd cart
...
cart Coin is now available at `./src/cartd`

Before running, you may create an empty configuration file:

    mkdir -p "/Users/${USER}/Library/Application Support/cart"

    touch "/Users/${USER}/Library/Application Support/cart/cart.conf"

    chmod 600 "/Users/${USER}/Library/Application Support/cart/cart.conf"

The first time you run cartd, it will start downloading the blockchain. This process could take many hours, or even days on slower than average systems.

You can monitor the download process by looking at the debug.log file:

    tail -f $HOME/Library/Application\ Support/cart/debug.log

Other commands:
-------

    ./src/cartd -daemon # Starts the cart daemon.
    ./src/cart-cli --help # Outputs a list of command-line options.
    ./src/cart-cli help # Outputs a list of RPC commands when the daemon is running.
