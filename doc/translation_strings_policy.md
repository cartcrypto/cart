...
This document provides guidelines for internationalization of the cart Coin software.
...
This can be checked by executing `make translate` in the `src` directory, then verifying that `cart_en.ts` remains unchanged.
