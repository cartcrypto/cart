...
cart.conf           | contains configuration settings for cartd or cart-qt
cartd.pid           | stores the process id of cartd while running
...
debug.log           | contains debug information and general logging generated by cartd or cart-qt
