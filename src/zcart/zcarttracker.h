...
#ifndef cart_ZcartTRACKER_H
#define cart_ZcartTRACKER_H
...
public:
    CzcartTracker(std::string strWalletFile);
    ~CzcartTracker();
    void Add(const CDeterministicMint& dMint, bool isNew = false, bool isArchived = false, CzcartWallet* zcartWallet = NULL);
