// Copyright (c) 2017-2018 The cart developers
// Distributed under the MIT software license, see the accompanying
// file COPYING or http://www.opensource.org/licenses/mit-license.php.

#ifndef cart_ZcartWALLET_H
#define cart_ZcartWALLET_H
...
public:
    CzcartWallet(std::string strWalletFile);
    ...
    void GenerateDeterministicZcart(libzerocoin::CoinDenomination denom, libzerocoin::PrivateCoin& coin, CDeterministicMint& dMint, bool fGenerateOnly = false);
    ...
    void UpdateCount();
    void Lock();
    void SeedToZcart(const uint512& seed, CBigNum& bnValue, CBigNum& bnSerial, CBigNum& bnRandomness, CKey& key);
