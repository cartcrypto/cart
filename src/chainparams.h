 ...
 * cart system. There are three: the main network on which people trade goods
...
public:
    ...
    int cartBadBlockTime() const { return ncartBadBlockTime; }
    int cartBadBlocknBits() const { return ncartBadBlocknBits; }
...
protected:
    ...
    int nLastPOWBlock;
    int64_t ncartBadBlockTime;
    unsigned int ncartBadBlocknBits;
