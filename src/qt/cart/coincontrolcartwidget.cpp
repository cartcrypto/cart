...
#include "qt/cart/forms/ui_coincontrolcartwidget.h"

CoinControlcartWidget::CoinControlcartWidget(QWidget *parent) :
    QDialog(parent),
    ui(new Ui::CoinControlcartWidget)
{
    ui->setupUi(this);
    ...
    ui->labelTitle->setText("Select cart Outputs to Spend");
    ...
    ui->labelTitleAmount->setText("cart");
    ...
    ui->labelValueAfter->setText("0.00 cart");
    ui->labelValueAmount->setText("0");
    ui->labelValueBytes->setText("0");
    ui->labelValueDust->setText("No");
    ui->labelValueChange->setText("0.00 cart");
    ui->labelValueFee->setText("0.00 cart");
...
CoinControlcartWidget::~CoinControlcartWidget()
{
    delete ui;
}
