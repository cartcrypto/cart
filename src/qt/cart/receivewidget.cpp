...
#include "qt/cart/forms/ui_receivewidget.h"
...
#include "qt/cart/addressholder.h"
...
ReceiveWidget::ReceiveWidget(cartGUI* parent) :
    PWidget(parent),
    ui(new Ui::ReceiveWidget)
{
    ...
    ui->labelSubtitle1->setText(tr("Scan the QR code or copy the address to receive cart."));
