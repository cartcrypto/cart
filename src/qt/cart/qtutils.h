...
bool openDialogWithOpaqueBackgroundY(QDialog *widget, cartGUI *gui, double posX = 3, int posY = 5);
bool openDialogWithOpaqueBackground(QDialog *widget, cartGUI *gui, double posX = 3);
