...
#include "qt/cart/settings/forms/ui_settingswalletrepairwidget.h"
#include "qt/cart/qtutils.h"

SettingsWalletRepairWidget::SettingsWalletRepairWidget(cartGUI* _window, QWidget *parent) :
...
void SettingsWalletRepairWidget::buildParameterlist(QString arg)
{
    ...
    // Send command-line arguments to cartGUI::handleRestart()
