...
#include "qt/cart/settings/forms/ui_settingswidget.h"
#include "qt/cart/settings/settingsbackupwallet.h"
#include "qt/cart/settings/settingsbittoolwidget.h"
#include "qt/cart/settings/settingswalletrepairwidget.h"
#include "qt/cart/settings/settingswalletoptionswidget.h"
#include "qt/cart/settings/settingsmainoptionswidget.h"
#include "qt/cart/settings/settingsdisplayoptionswidget.h"
#include "qt/cart/settings/settingsmultisendwidget.h"
#include "qt/cart/settings/settingsinformationwidget.h"
#include "qt/cart/settings/settingsconsolewidget.h"
...
SettingsWidget::SettingsWidget(cartGUI* parent) :
    PWidget(parent),
