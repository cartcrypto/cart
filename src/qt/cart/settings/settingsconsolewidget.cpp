...
#include "qt/cart/settings/forms/ui_settingsconsolewidget.h"
...
#include "qt/cart/settings/moc_settingsconsolewidget.cpp"
...
SettingsConsoleWidget::SettingsConsoleWidget(cartGUI* _window, QWidget *parent) :
