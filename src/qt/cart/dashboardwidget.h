...
#include "config/cart-config.h" /* for USE_QTCHARTS */
#endif
...
public:
    ...
    qint64 totalcart = 0;
    qint64 totalZcart = 0;
    QList<qreal> valuescart;
    QList<qreal> valueszcart;
    QStringList xLabels;
};
...
public:
    explicit DashboardWidget(cartGUI* _window);
    ~DashboardWidget();
