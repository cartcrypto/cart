...
#include "qt/cart/contactsdropdown.h"
#include "qt/cart/sendmultirow.h"
#include "qt/cart/sendcustomfeedialog.h"
...
public:
    explicit SendWidget(cartGUI* parent);
    ~SendWidget();
...
private slots:
    void oncartSelected(bool _iscart);
    void onSendClicked();
...
private:
    ...
    bool sendZcart(QList<SendCoinsRecipient> recipients);
