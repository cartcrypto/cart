                                          ...
                                          banTableContextMenu(0)
{
    ...
    std::string strzcartPathCustom = GetArg("-zcartbackuppath", "");
    ...
    if(!strzcartPathCustom.empty()) {
        ui->wallet_customzcartbackuppath->setText(QString::fromStdString(strzcartPathCustom));
        ui->wallet_customzcartbackuppath_label->setVisible(true);
        ui->wallet_customzcartbackuppath->setVisible(true);
    }

    if((!strPathCustom.empty() || !strzcartPathCustom.empty()) && nCustomBackupThreshold > 0) {
