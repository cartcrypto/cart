                                                                    ...
                                                                    ui(new Ui::HelpMessageDialog)
{
    ...
    QString version = tr("cart Coin") + " " + tr("version") + " " + QString::fromStdString(FormatFullVersion());
/* On x86 add a bit specifier to the version so that users can distinguish between
    ...
    if (about) {
        setWindowTitle(tr("About cart Coin"));
        ...
        licenseInfoHTML.replace(uri, "<a style='color: #898989;text-decoration:none'  href=\"\\1\">\\1</a>");
...
ShutdownWindow::ShutdownWindow(QWidget* parent, Qt::WindowFlags f) : QWidget(parent, f)
{
    ...
    layout->addWidget(new QLabel(
        tr("cart Coin is shutting down...") + "<br /><br />" +
