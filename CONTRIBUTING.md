Contributing to cart Coin
============================

The cart Coin project operates an open contributor model where anyone is
...
[Translation Process](https://github.com/cartcrypto/cart/blob/master/doc/translation_process.md)
...
The following applies to code changes to the cart Coin project, and is not to be
confused with overall cart Network Protocol consensus changes.

Whether a pull request is merged into cart Coin rests with the project merge
...
Patches that change cart consensus rules are considerably more involved than
...
Where a patchset proposes to change the cart consensus, it must have been
...
The project leader is the release manager for each cart Coin release.
