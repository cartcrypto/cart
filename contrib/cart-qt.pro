...
RESOURCES += src/qt/cart.qrc src/qt/cart_locale.qrc

TRANSLATIONS += src/qt/locale/cart_bg.ts \
                src/qt/locale/cart_de.ts \
                src/qt/locale/cart_en.ts \
                src/qt/locale/cart_es.ts \
                src/qt/locale/cart_fi.ts \
                src/qt/locale/cart_fr.ts \
                src/qt/locale/cart_it.ts \
                src/qt/locale/cart_ja.ts \
                src/qt/locale/cart_pl.ts \
                src/qt/locale/cart_pt.ts \
                src/qt/locale/cart_ru.ts \
                src/qt/locale/cart_sk.ts \
                src/qt/locale/cart_sv.ts \
                src/qt/locale/cart_vi.ts \
                src/qt/locale/cart_zh_CN.ts \
                src/qt/locale/cart_zh_TW.ts
