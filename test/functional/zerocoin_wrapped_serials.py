...
from fake_stake.base_test import cart_FakeStakeTest

class zcartwrappedSerialsTest(cart_FakeStakeTest):
    ...
    def run_test(self):
        ...
        # 2) Mint zerocoins
        self.log.info("Minting %d-denom zcarts..." % DENOM_TO_USE)
