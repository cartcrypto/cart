...
from test_framework.cart_node import cartTestNode
...
class cart_ColdStakingTest(BitcoinTestFramework):
    ...
    def init_test(self):
        ...
        for i in range(self.num_nodes):
            self.test_nodes.append(cartTestNode())
